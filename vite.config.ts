...
const manifest: Partial<ManifestOptions> = {
	...
	shortcuts: [
		{ name: "Mis clases", url: "/", icons: [{ src: "logo.svg" }] },
		{ name: "Perfil", url: "/profile", icons: [{ src: "logo.svg" }] },
	],
	screenshots: [
		{
			src: "screenshots/02SignIn.png",
			sizes: "1080x1920",
			type: "image/png",
		},
		{
			src: "screenshots/04Subjects.png",
			sizes: "1080x1920",
			type: "image/png",
		},
		{
			src: "screenshots/09Activities.png",
			sizes: "1080x1920",
			type: "image/png",
		},
		{
			src: "screenshots/19ShareButtons.png",
			sizes: "1080x1920",
			type: "image/png",
		},
		{
			src: "screenshots/20Settings.png",
			sizes: "1080x1920",
			type: "image/png",
		},
	],
