...
export const saveClassPeriods = async (
	classPeriods: ClassPeriodTransaction[],
): Promise<void> => {
...
export const saveAttendanceDays = async (
	attDays: AttendanceDayTransaction[],
): Promise<void> => {
