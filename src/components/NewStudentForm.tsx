...
const validators: {
	[key in keyof NewStudentFormData]: Array<(val: string) => string>;
} = {
...
const NewStudentForm: Component<Props> = (props) => {
	...
	const isDisabled = (): boolean => {
		return Object.keys(formData)
			...
			.some(
				(key) =>
					formData[key as keyof NewStudentFormData].errorMsg !== "" ||
			...
			>
				...
				<Flex flexDirection="column">
					...
					<Input
						...
						onInput={onChange}
						invalid={
							formData.last_name.isTouched && formData.last_name.errorMsg !== ""
						}
						autocomplete="off"
					/>
					<Show
