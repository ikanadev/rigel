...
const Drawer: Component<Props> = (props) => {
	...
	return (
		<>
			<StartPeriodModal
				isOpen={newPeriodModal.isActive()}
				onClose={newPeriodModal.disable}
			/>
			<FinishPeriodModal
				isOpen={finishPeriodModal.isActive()}
				onClose={finishPeriodModal.disable}
			/>
			<AboutModal isOpen={aboutModal.isActive()} onClose={aboutModal.disable} />
			<ContactModal
				isOpen={contactModal.isActive()}
				onClose={contactModal.disable}
			/>
			<LogoutModal
				isOpen={logoutModal.isActive()}
				onClose={logoutModal.disable}
			/>
			<SettingsModal
				isOpen={settingsModal.isActive()}
				onClose={settingsModal.disable}
			/>
						...
						>
							<Flex justifyContent="end" alignItems="center" gap="$2">
								...
								<IconButton
									...
									href={`https://wa.me/?text=${encodeURIComponent(
										...
										} - ${classStore.class!.grade.name}, Par. ${
							...
							<Text size="sm">
								...
								<Text
									...
									fontWeight="$semibold"
									color={
										classStore.classPeriod !== null ? undefined : "$neutral10"
									}
								>
									{classStore.classPeriod !== null
										? classStore.classPeriod.period.name
										: "No iniciado"}
								</Text>
							</Text>
							<Text size="sm">
								...
								<Show
									...
									fallback={
										<Text
											...
											my="$6"
										>
											Debe iniciar un periodo para administrar asistencias y
											tareas.
										</Text>
									}
								>
