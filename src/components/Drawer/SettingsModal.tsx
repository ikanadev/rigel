					...
					<Flex mt="$4" pl="$2" flexDirection="column" gap="$5" maxW="$sm">
						...
						<Show when={fontStore.valid}>
							<Flex flexDirection="column" alignItems="end">
								...
								<RadioGroup
									value={fontStore.activeSize}
									onChange={(val) => setFontSize(parseInt(val))}
									size="sm"
								>
									<Flex flexDirection="column" gap="$1">
										<Radio value={fontStore.sizes.sm} labelPlacement="start">
											Pequeño
										</Radio>
										<Radio value={fontStore.sizes.md} labelPlacement="start">
											Mediano
										</Radio>
										<Radio value={fontStore.sizes.lg} labelPlacement="start">
											Grande
										</Radio>
										<Radio value={fontStore.sizes.xl} labelPlacement="start">
											Extra Grande
										</Radio>
									</Flex>
								</RadioGroup>
