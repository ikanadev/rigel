            ...
            colSpan={
              classPeriod.areas.reduce(
                (res, area) => {
                  ...
                  // activities + average
                  return res + (area.acts.length > 0 ? area.acts.length + 1 : 1);
                },
                0,
                // + final
              ) + 1
                ...
                <Th
                  colSpan={
                    props.viewMode === ViewMode.Activity
                      ? area.acts.length > 0 ? area.acts.length + 1 : 1
                      : 1
                  }
                  borderBottom="none"
                  textAlign="center"
              ...
              <>
                <Show when={props.viewMode === ViewMode.Activity}>
                  <For each={area.acts}>{(act, i) => (
                    <Td borderLeft={i() === 0 ? `${areaIndex() === 0 ? '3' : '1.5'}px solid $neutral4` : undefined}>
