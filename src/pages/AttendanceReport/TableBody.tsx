    ...
    <Tbody>
      <For each={ps.students}>{(student) => (
        <Tr>
          ...
          <For each={ps.classPeriods}>{(classPeriod, classPeriodIndex) => (
            <>
              <For each={classPeriod.attDays}>{(attDay, attDayIndex) => (
                <Td px="$1" borderLeft={attDayIndex() === 0 ? '3px solid $neutral4' : undefined} display={!ps.showDays ? 'none' : undefined}>
          ...
          <Td fontWeight="$bold" bg="$success2" color="$success10" textAlign="center" borderLeft="3px solid $neutral4">
            {student.yearAtts.Presente}
          </Td>
          <Td fontWeight="$bold" bg="$danger2" color="$danger10" textAlign="center">
            {student.yearAtts.Falta}
          </Td>
          <Td fontWeight="$bold" bg="$warning2" color="$warning10" textAlign="center">
            {student.yearAtts.Atraso}
          </Td>
          <Td fontWeight="$bold" bg="$info2" color="$info10" textAlign="center">
