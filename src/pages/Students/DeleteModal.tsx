...
const DeleteModal: Component<ModalProps & { student: Student | null }> = (
	props,
) => {
	...
	return (
		<Modal {...modalProps} size="lg">
			...
			<ModalContent>
				<ModalCloseButton />
				<ModalHeader>
					¿Borrar estudiante {studentProp.student?.name}?
				</ModalHeader>
				<ModalBody>
					<Alert text={errMsg()} setText={setErrMsg} status="danger" />
					<Text>
						Se eliminarán todas las asistencias y notas del estudiante.
					</Text>
				</ModalBody>
				<ModalFooter>
